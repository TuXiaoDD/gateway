...
public class ClassUtils {
    ...
    public static final Object newProxyInstance(InvocationHandler invocationHandler ,Class<?>[] clazzs) {
        return Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), clazzs,
            invocationHandler);
    }
